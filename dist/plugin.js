var capacitorCapacitorZebraPrinterBT = (function (exports, core) {
    'use strict';

    const CapacitorZebraPrinterBT = core.registerPlugin('CapacitorZebraPrinterBT', {
        web: () => Promise.resolve().then(function () { return web; }).then(m => new m.CapacitorZebraPrinterBTWeb()),
    });
    ...
    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        CapacitorZebraPrinterBTWeb: CapacitorZebraPrinterBTWeb
    });
